// =====================================================================
// RATTLE EMPIRE v8.0 — Premium Digital Marketplace (Consolidated)
// =====================================================================

// ===== CONFIG (edit these) =====
const ALERT_URL    = "https://re-hook-8842.piratevillain99.workers.dev";
const ALERT_SECRET = "RE-9f3kZq-X7mW-2026";
const FORM_EMAIL   = ""; // optional email backup via FormSubmit
...
// ===== CATEGORIES =====
const categories = [
    { id: "all",          name: "All Products", emoji: "🔥", icon: "fa-border-all",           image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=200&h=150&fit=crop" },
    { id: "chatgpt",      name: "ChatGPT",      emoji: "🤖", icon: "fa-robot",                image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=200&h=150&fit=crop" },
    { id: "claude",       name: "Claude",       emoji: "🧠", icon: "fa-brain",                image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=200&h=150&fit=crop" },
    { id: "gemini",       name: "Gemini",       emoji: "✨", icon: "fa-gem",                  image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=200&h=150&fit=crop" },
    { id: "netflix",      name: "Netflix",      emoji: "🎬", icon: "fa-film",                 image: "https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=200&h=150&fit=crop" },
    { id: "spotify",      name: "Spotify",      emoji: "🎵", icon: "fa-music",                image: "https://images.unsplash.com/photo-1611339555312-e607c835872e?w=200&h=150&fit=crop" },
    { id: "youtube",      name: "YouTube",      emoji: "📺", icon: "fa-youtube",              image: "https://images.unsplash.com/photo-1611162616475-46b635cb6868?w=200&h=150&fit=crop" },
    { id: "midjourney",   name: "Midjourney",   emoji: "🎨", icon: "fa-wand-magic-sparkles",  image: "https://images.unsplash.com/photo-1633419461250-d1d1a3d1d1d1?w=200&h=150&fit=crop" },
    { id: "developer",    name: "Developer",    emoji: "💻", icon: "fa-code",                 image: "https://images.unsplash.com/photo-1618401471353-b98afee0b2eb?w=200&h=150&fit=crop" },
    { id: "creative",     name: "Creative",     emoji: "🎨", icon: "fa-palette",              image: "https://images.unsplash.com/photo-1626785774573-4b799315345d?w=200&h=150&fit=crop" },
    { id: "ai-tools",     name: "AI Tools",     emoji: "🧠", icon: "fa-wand-magic-sparkles",  image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=200&h=150&fit=crop" },
    { id: "productivity", name: "Productivity", emoji: "📝", icon: "fa-list-check",           image: "https://images.unsplash.com/photo-1455390582262-044cdead3037?w=200&h=150&fit=crop" }
];

// ===== PRODUCTS =====
const products = [
    { id: 1,  name: "ChatGPT Plus (1 Month)",         price: 45000,  originalPrice: 80000,   category: "chatgpt",      seller: "Trevor Labs",      sellerLoc: "Kampala", rating: 4.9, reviews: 128, sold: 342, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=400&h=300&fit=crop", description: "Full ChatGPT Plus with GPT-4, DALL-E, voice mode & priority access." },
    { id: 2,  name: "ChatGPT Plus (3 Months)",        price: 120000, originalPrice: 240000,  category: "chatgpt",      seller: "Trevor Labs",      sellerLoc: "Kampala", rating: 4.9, reviews: 89,  sold: 156, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=400&h=300&fit=crop", description: "3 months of ChatGPT Plus. Save 50%." },
    { id: 3,  name: "ChatGPT Plus (1 Year)",          price: 420000, originalPrice: 960000,  category: "chatgpt",      seller: "Trevor Labs",      sellerLoc: "Kampala", rating: 5.0, reviews: 45,  sold: 78,  featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=400&h=300&fit=crop", description: "Full year of ChatGPT Plus. Best value." },
    { id: 4,  name: "Claude Pro (1 Month)",           price: 55000,  originalPrice: 90000,   category: "claude",       seller: "AI Masters",       sellerLoc: "Kampala", rating: 4.8, reviews: 67,  sold: 189, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=400&h=300&fit=crop", description: "Claude Pro with 200K context & Claude 3 Opus." },
    { id: 5,  name: "Claude Pro (3 Months)",          price: 150000, originalPrice: 270000,  category: "claude",       seller: "AI Masters",       sellerLoc: "Kampala", rating: 4.9, reviews: 42,  sold: 95,  featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=400&h=300&fit=crop", description: "3 months of Claude Pro." },
    { id: 6,  name: "Netflix Premium 4K (1 Month)",   price: 25000,  originalPrice: 50000,   category: "netflix",      seller: "StreamHub",        sellerLoc: "Kampala", rating: 4.7, reviews: 234, sold: 567, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=400&h=300&fit=crop", description: "Netflix Premium 4K with 4 screens." },
    { id: 7,  name: "Netflix Premium 4K (3 Months)",  price: 65000,  originalPrice: 150000,  category: "netflix",      seller: "StreamHub",        sellerLoc: "Kampala", rating: 4.8, reviews: 156, sold: 389, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=400&h=300&fit=crop", description: "3 months Netflix 4K. Save 57%." },
    { id: 8,  name: "Spotify Premium (1 Month)",      price: 18000,  originalPrice: 35000,   category: "spotify",      seller: "StreamHub",        sellerLoc: "Kampala", rating: 4.6, reviews: 189, sold: 423, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1611339555312-e607c835872e?w=400&h=300&fit=crop", description: "Ad-free Spotify Premium." },
    { id: 9,  name: "YouTube Premium (1 Month)",      price: 22000,  originalPrice: 40000,   category: "youtube",      seller: "StreamHub",        sellerLoc: "Kampala", rating: 4.7, reviews: 145, sold: 312, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1611162616475-46b635cb6868?w=400&h=300&fit=crop", description: "YouTube Premium - ad-free + YT Music." },
    { id: 10, name: "Midjourney Basic (1 Month)",     price: 35000,  originalPrice: 60000,   category: "midjourney",   seller: "AI Creators",      sellerLoc: "Kampala", rating: 4.8, reviews: 78,  sold: 167, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1633419461250-d1d1a3d1d1d1?w=400&h=300&fit=crop", description: "Midjourney Basic - 200 generations/month." },
    { id: 11, name: "Midjourney Standard (1 Month)",  price: 85000,  originalPrice: 150000,  category: "midjourney",   seller: "AI Creators",      sellerLoc: "Kampala", rating: 4.9, reviews: 56,  sold: 98,  featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1633419461250-d1d1a3d1d1d1?w=400&h=300&fit=crop", description: "900 generations + relax mode." },
    { id: 12, name: "Adobe Creative Cloud (1 Month)", price: 180000, originalPrice: 350000,  category: "creative",     seller: "Creative Pro",     sellerLoc: "Kampala", rating: 4.7, reviews: 34,  sold: 67,  featured: false, warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1626785774573-4b799315345d?w=400&h=300&fit=crop", description: "Full Adobe CC suite - 20+ apps." },
    { id: 13, name: "GitHub Copilot (1 Month)",       price: 40000,  originalPrice: 70000,   category: "developer",    seller: "DevTools Pro",     sellerLoc: "Kampala", rating: 4.8, reviews: 89,  sold: 145, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1618401471353-b98afee0b2eb?w=400&h=300&fit=crop", description: "AI pair programmer. Writes code as you type." },
    { id: 14, name: "Cursor Pro (1 Month)",           price: 55000,  originalPrice: 95000,   category: "developer",    seller: "DevTools Pro",     sellerLoc: "Kampala", rating: 4.9, reviews: 45,  sold: 78,  featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1618401471353-b98afee0b2eb?w=400&h=300&fit=crop", description: "AI-first code editor. 10x your speed." },
    { id: 15, name: "Notion Plus (1 Year)",           price: 95000,  originalPrice: 180000,  category: "productivity", seller: "Productivity Hub", sellerLoc: "Entebbe", rating: 4.6, reviews: 67,  sold: 123, featured: false, warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1611224923853-80b05380f1d5?w=400&h=300&fit=crop", description: "Unlimited uploads, 30-day history." },
    { id: 16, name: "Grammarly Premium (1 Year)",     price: 75000,  originalPrice: 150000,  category: "productivity", seller: "Productivity Hub", sellerLoc: "Entebbe", rating: 4.7, reviews: 89,  sold: 167, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1455390582262-044cdead3037?w=400&h=300&fit=crop", description: "Advanced suggestions & plagiarism checker." },
    { id: 17, name: "Perplexity Pro (1 Month)",       price: 45000,  originalPrice: 80000,   category: "ai-tools",     seller: "AI Masters",       sellerLoc: "Kampala", rating: 4.8, reviews: 34,  sold: 56,  featured: false, warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=400&h=300&fit=crop", description: "Unlimited pro searches, GPT-4 access." },
    { id: 18, name: "Runway ML (1 Month)",            price: 65000,  originalPrice: 120000,  category: "creative",     seller: "AI Creators",      sellerLoc: "Kampala", rating: 4.7, reviews: 28,  sold: 45,  featured: false, warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1626785774573-4b799315345d?w=400&h=300&fit=crop", description: "AI video generation, 100+ tools." },
    { id: 19, name: "ElevenLabs (1 Month)",           price: 55000,  originalPrice: 100000,  category: "ai-tools",     seller: "AI Creators",      sellerLoc: "Kampala", rating: 4.8, reviews: 45,  sold: 78,  featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=400&h=300&fit=crop", description: "AI voice generation in 29 languages." },
    { id: 20, name: "Canva Pro (1 Year)",             price: 85000,  originalPrice: 170000,  category: "creative",     seller: "Creative Pro",     sellerLoc: "Kampala", rating: 4.6, reviews: 123, sold: 234, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1626785774573-4b799315345d?w=400&h=300&fit=crop", description: "Unlimited templates, 100GB storage." },
    { id: 21, name: "Gemini Advanced (1 Month)",      price: 50000,  originalPrice: 90000,   category: "gemini",       seller: "AI Masters",       sellerLoc: "Kampala", rating: 4.8, reviews: 56,  sold: 134, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=400&h=300&fit=crop", description: "Gemini Advanced - 1M token context." },
    { id: 22, name: "Grok Premium (1 Month)",         price: 55000,  originalPrice: 95000,   category: "ai-tools",     seller: "AI Masters",       sellerLoc: "Kampala", rating: 4.7, reviews: 34,  sold: 67,  featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=400&h=300&fit=crop", description: "X AI Grok Premium." },
    { id: 23, name: "Suno AI Pro (1 Month)",          price: 40000,  originalPrice: 70000,   category: "creative",     seller: "AI Creators",      sellerLoc: "Kampala", rating: 4.7, reviews: 28,  sold: 54,  featured: false, warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=400&h=300&fit=crop", description: "Suno Pro - full songs with vocals." },
    { id: 24, name: "Leonardo AI (1 Month)",          price: 45000,  originalPrice: 80000,   category: "midjourney",   seller: "AI Creators",      sellerLoc: "Kampala", rating: 4.6, reviews: 22,  sold: 41,  featured: false, warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1633419461250-d1d1a3d1d1d1?w=400&h=300&fit=crop", description: "Game-ready art, 8500 tokens/month." },
    { id: 25, name: "CapCut Pro (1 Month)",           price: 25000,  originalPrice: 45000,   category: "creative",     seller: "Creative Pro",     sellerLoc: "Kampala", rating: 4.8, reviews: 89,  sold: 210, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=400&h=300&fit=crop", description: "CapCut Pro - premium effects, no watermark." },
    { id: 26, name: "Discord Nitro (1 Month)",        price: 35000,  originalPrice: 60000,   category: "productivity", seller: "Productivity Hub", sellerLoc: "Entebbe", rating: 4.6, reviews: 45,  sold: 98,  featured: false, warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1614680376573-df3480f0c6ff?w=400&h=300&fit=crop", description: "HD streaming, custom emoji anywhere." },
    { id: 27, name: "Telegram Premium (1 Year)",      price: 65000,  originalPrice: 120000,  category: "productivity", seller: "Productivity Hub", sellerLoc: "Entebbe", rating: 4.7, reviews: 67,  sold: 145, featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1611162616475-46b635cb6868?w=400&h=300&fit=crop", description: "4GB uploads, faster downloads, no ads." },
    { id: 28, name: "Zoom Pro (1 Month)",             price: 50000,  originalPrice: 90000,   category: "productivity", seller: "Productivity Hub", sellerLoc: "Entebbe", rating: 4.5, reviews: 18,  sold: 32,  featured: false, warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=400&h=300&fit=crop", description: "30h meetings, cloud recording." },
    ...
    { id: 30, name: "iCloud+ 200GB (1 Month)",        price: 30000,  originalPrice: 55000,   category: "productivity", seller: "DevTools Pro",     sellerLoc: "Kampala", rating: 4.6, reviews: 26,  sold: 64,  featured: false, warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&h=300&fit=crop", description: "iCloud+ 200GB with Private Relay." },
    { id: 31, name: "Perplexity Pro (1 Year)",        price: 420000, originalPrice: 720000,  category: "ai-tools",     seller: "AI Masters",       sellerLoc: "Kampala", rating: 4.9, reviews: 41,  sold: 58,  featured: true,  warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=400&h=300&fit=crop", description: "Full year Perplexity Pro." },
    { id: 32, name: "ElevenLabs Creator (1 Month)",   price: 85000,  originalPrice: 150000,  category: "ai-tools",     seller: "AI Creators",      sellerLoc: "Kampala", rating: 4.8, reviews: 33,  sold: 47,  featured: false, warranty: "lifetime", delivery: "instant", image: "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=400&h=300&fit=crop", description: "100k credits, voice cloning." },
...
const communityRequests = [
    { id: 1, user: "Grace M.",   location: "Kampala",  text: "Looking for ChatGPT Plus with GPT-4 Turbo access.",                       time: "2 hours ago",  replies: 5, avatar: "#7000ff", whatsapp: "256775123456" },
    { id: 2, user: "Daniel O.",  location: "Entebbe",  text: "Anyone selling Midjourney accounts with fast mode?",                       time: "4 hours ago",  replies: 3, avatar: "#00d4ff", whatsapp: "256775234567" },
    ...
    { id: 5, user: "Esther W.",  location: "Kampala",  text: "Anyone have Claude Pro accounts? Prefer 3+ months.",                      time: "12 hours ago", replies: 6, avatar: "#f472b6", whatsapp: "256775567890" }
];
const CUSTOMER_DB = {
...
const testimonials = [
    { name: "Sarah K.",    role: "Kampala", text: "Just received my ChatGPT Plus! Amazing quality and fast delivery. Rattle Empire is the real deal!",    stars: 5, color: "#00f0ff" },
    { name: "Brian T.",    role: "Entebbe", text: "Best marketplace in Uganda! Found exactly what I was looking for at a great price.",                    stars: 5, color: "#ff00ff" },
    { name: "Grace M.",    role: "Jinja",   text: "Quality products, fair prices, and excellent customer support. Rattle Empire never disappoints!",       stars: 5, color: "#4ade80" },
    ...
    { name: "Faith N.",    role: "Gulu",    text: "Midjourney account working flawlessly. Creating amazing art for my clients every day.",                 stars: 5, color: "#ff3366" }
];
...
function productCardHTML(p, i) {
    ...
    <div class="product-card" style="animation-delay:${i * 0.05}s">
        <div class="card-img brand" onclick="openProductModal(${p.id})">
            <img src="https://logo.clearbit.com/${brandDomain(p)}" alt="${p.name}" loading="lazy" decoding="async" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
...
// ===== RENDER: FEATURED / QUICK DEALS / HOT DEALS / FLASH SALE =====
function renderFeatured() {
    const grid = document.getElementById('featured-grid');
    if (!grid) return;
    grid.innerHTML = [...products].sort((a, b) => (b.rating * b.sold) - (a.rating * a.sold)).slice(0, 4).map((p, i) => productCardHTML(p, i)).join('');
}
function renderQuickDeals() {
    const grid = document.getElementById('quick-deals-grid');
    if (!grid) return;
    grid.innerHTML = [...products].map(p => ({ ...p, disc: p.originalPrice ? Math.round(((p.originalPrice - p.price) / p.originalPrice) * 100) : 0 })).sort((a, b) => b.disc - a.disc).slice(0, 6).map((p, i) => productCardHTML(p, i)).join('');
}
function renderHotDeals() {
    const row = document.getElementById('hot-deals-row');
    if (!row) return;
    row.innerHTML = [...products].sort((a, b) => b.sold - a.sold).slice(0, 8).map((p, i) => productCardHTML(p, i)).join('');
}
...
function renderProducts() {
    ...
    if (heading) {
        if (currentCategory === 'all') heading.innerHTML = '<i class="fas fa-crown"></i> Premium Accounts';
        else {
    ...
    grid.innerHTML = courses.map(c => {
        ...
        <div class="course-card" onclick="openCourseModal('${c.id}')">
            <div class="course-img">
                <img class="logo" src="https://logo.clearbit.com/${c.brand || 'openai.com'}" alt="${c.title}" loading="lazy" decoding="async" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
...
function renderEnhancedSellers() {
    ...
    if (!list) return;
    const enriched = sellers.map((s, i) => ({ ...s, followers: 50 + i * 23, listings: 5 + i * 2 }));
    list.innerHTML = [...enriched].sort((a, b) => a.rank - b.rank).map(s => `
        <div class="seller-card">
            ...
            <a href="https://wa.me/256775374095?text=Hi ${s.name}! I'm interested in your products" class="btn-contact" target="_blank"><i class="fab fa-whatsapp"></i> Contact</a>
        </div>`).join('');
}
            ...
            <div class="request-header">
                <div class="request-user">
                    ...
                    <div class="request-user-info">
                        <div class="name">${r.user} ${r.mine ? '<span style="color:#4ade80;font-size:10px">(you)</span>' : ''}</div>
...
function filterProducts(query) {
    ...
    const filtered = products.filter(p =>
        ...
        p.seller.toLowerCase().includes(q) || p.description.toLowerCase().includes(q));
    grid.innerHTML = filtered.map((p, i) => productCardHTML(p, i)).join('');
}
let _searchTimer;
function debouncedSearch(q) { clearTimeout(_searchTimer); _searchTimer = setTimeout(() => filterProducts(q), 200); }
function trendSearch(q) { const input = document.getElementById('search-input'); if (input) { input.value = q; filterProducts(q); } scrollToSection('products-section'); }
...
function updateCartUI() {
    ...
    if (btn) btn.href = `https://wa.me/256775374095?text=Hi! I'd like to order:%0a${msg}%0a%0aTotal: UGX ${totalPrice.toLocaleString()}`;
}
function toggleCart() {
...
function openCourseModal(id) {
    ...
    document.getElementById('modal-content').innerHTML = `
        ...
        <div class="modal-actions">
            <button class="btn-add-modal" onclick="showToast('<i class=\\'fas fa-check-circle\\' style=\\'color:#4ade80\\'></i> Contact us on WhatsApp to enroll.'); closeProductModal();"><i class="fas fa-graduation-cap"></i> Enroll Now</button>
            <a class="btn-wa-modal" href="https://wa.me/256775374095?text=Hi! I want to enroll in: ${encodeURIComponent(c.title)}" target="_blank"><i class="fab fa-whatsapp"></i></a>
        </div>`;
    document.getElementById('product-modal').classList.add('open');
}

// ===== HANDLERS: POST / COMMUNITY =====
...
function submitPost() {
    ...
    setTimeout(() => {
        ...
        tgSend(`💬 Reply from ${seller.name} to request: "${text.substring(0, 60)}..."`);
    }, 15000 + Math.random() * 25000);
}

// ===== HANDLERS: LOGIN / ACCOUNT =====
function openLogin() {
...
function submitSellerApp() {
    ...
    window.open(`https://wa.me/256775374095?text=${msg}`, '_blank');
}
...
function startHeroEngine() {
    setInterval(() => { if (!document.hidden) coinFlipTo((carouselIndex + 1) % 3); }, 6000);
}

// ===== REAL-TIME ENGINE =====
const rtChannel = ('BroadcastChannel' in window) ? new BroadcastChannel('rattle_rt') : null;
if (rtChannel) rtChannel.onmessage = e => {
    const ev = e.data;
    if (ev.type === 'reply') showToast(`<i class="fas fa-comment-dots" style="color:#4ade80"></i> ${ev.seller} replied`);
...
function spawnNotification() {
    ...
    notif.innerHTML = `<div class="notif-icon ${iconClass}"><i class="fas ${icon}"></i></div><div class="notif-body"><div class="notif-title">${title}</div><div class="notif-text">${text}</div><div class="notif-time">${time}</div></div><button class="notif-close" onclick="this.parentElement.remove()"><i class="fas fa-xmark"></i></button>`;
...
function startNotificationEngine() {
    ...
    function scheduleNext() { setTimeout(() => { spawnNotification(); scheduleNext(); }, Math.floor(Math.random() * 15000) + 10000); }
    scheduleNext();
}
...
// ===== CATALOG OVERRIDES (admin panel + cloud sync) =====
...
function renderStorefront() {
    renderCategoryRow(); renderFeatured(); renderFlashSale();
    renderQuickDeals(); renderHotDeals(); renderProducts();
}
...
// ===== BOTTOM NAV: rebuild once, immediately =====
(function rebuildNav() {
...
// ===== APPLY CATALOG OVERRIDES BEFORE ANY RENDER =====
...
// Pause testimonial rotation when tab hidden
