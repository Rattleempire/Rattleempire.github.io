...
function openProductModal(id) {
    ...
    document.getElementById('modal-content').innerHTML =
        ...
        '<div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;"><span style="font-size:24px;font-weight:900;background:linear-gradient(135deg,#7000ff,#00d4ff);-webkit-background-clip:text;background-clip:text;color:transparent;">UGX ' + p.price.toLocaleString() + '</span>' +
        ...
        '<div class="modal-actions"><button class="btn-add-modal" onclick="addToCart(products.find(x=>x.id===' + p.id + ')); closeProductModal();"><i class="fas fa-cart-plus"></i> Add to Cart</button>' +
...
function openCourseModal(id) {
    ...
    document.getElementById('modal-content').innerHTML =
        ...
        '<div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;"><span style="font-size:24px;font-weight:900;background:linear-gradient(135deg,#7000ff,#00d4ff);-webkit-background-clip:text;background-clip:text;color:transparent;">UGX ' + c.price.toLocaleString() + '</span>' +
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('catalog.json').then(r => r.ok ? r.json() : null).then
