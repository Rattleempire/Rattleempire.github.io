...
try {
    ...
    // Set persistence safely after auth is ready
...
// ===== DOM ELEMENTS =====
let productGrid, categoryTitle, categoryDesc, cartSidebar, cartItems, cartTotal, cartCount;
let testimonialCard, themeToggle, authBtn, paymentModal, modalTotal, confirmPaymentBtn, cancelPaymentBtn;
let adminPanel, adminTrigger, searchInput, sortSelect, cartFab, closeCart, checkoutBtn;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    testimonialCard = document.getElementById('testimonialCard');
                    ...
                    if (error.code === 'auth/user-not-found' || error.code === 'auth/wrong-password') {
                        if (confirm('No account found. Create one?')) {
                            auth.createUserWithEmailAndPassword(email, password)
                                .then(() => showToast('Account created! Welcome to Rattle Empire! 👑', 'success'))
